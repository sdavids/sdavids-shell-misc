...
{function_url}[This function^] will display the https://docs.oracle.com/javase/tutorial/deployment/jar/manifestindex.html[manifest] of the given https://docs.oracle.com/en/java/javase/25/docs/specs/man/jar.html[JAR] file.
