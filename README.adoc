...
[TIP]
====
Copy the script (and its related <<create-ca,create-ca>> script) into your Node.js project and add it as a https://docs.npmjs.com/cli/v10/commands/npm-run-script[custom script] to your `package.json` file:
