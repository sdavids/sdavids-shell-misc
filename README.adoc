...
link:scripts/docker/docker-health.sh[This script] will query the https://docs.docker.com/reference/dockerfile/#healthcheck[health status] of the running container named `${container_name}`, i.e. the project's container.
