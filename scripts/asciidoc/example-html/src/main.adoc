...
:github-org-url: https://github.com/sdavids
:github-repo: sdavids-shell-misc
:some-version: 1.2.3
...
// https://docs.asciidoctor.org/asciidoc/latest/attributes/reference-attributes/#reference-custom
{github-org-url}/{github-repo}

// https://docs.asciidoctor.org/asciidoc/latest/attributes/reference-attributes/#enclose-in-a-passthrough
+{some-version}+ has the value {some-version}.
...
host.docker.internal:5432:example_db:admin:**PASSWORD**
----
...
[plantuml,diagram-c4-system,svg]
----
@startuml
...
* https://github.com/plantuml-stdlib/C4-PlantUML?tab=readme-ov-file#system-context--system-landscape-diagrams[C4-PlantUML - System Landscape]

==== C4 Container Diagram

[plantuml,diagram-c4-container,svg]
----
@startuml
...
!include AWSPuml/Containers/ElasticContainerServiceContainer2.puml
...
AddElementTag("addition", $fontColor="seagreen")
AddElementTag("modification", $fontColor="darkorange")

Container(fe, "Frontend", $sprite="FrontEndWebMobile")

Container(awsc, "Cognito", $sprite="Cognito")

Container(awsalb, "App Load Balancer", $sprite="ElasticLoadBalancingApplicationLoadBalancer")

Container(awscf, "CloudFront", $sprite="CloudFront", $tags = "modification")

Boundary(awsecs, "ECS Fargate", $tags = "modification") {
  Container(b1, "Backend 1", "Spring Boot", $sprite="ElasticContainerServiceContainer2", $descr="validates JWT")

  Container(b2, "Backend 2", "Node.js", $sprite="ElasticContainerServiceContainer2", $tags = "addition")
}

ContainerDb(awsap, "Database", $sprite="AuroraPostgreSQLInstance")

Container(eap, "Auth Proxy", $sprite="Lambda", $descr="validates JWT", $tags = "addition")

Rel(fe, awsc, "retrieve JWT")

Rel(fe, awscf, "GET /a", $descr="with JWT")
Rel(fe, awscf, "GET /b", $descr="with JWT")

Rel(awscf, awsalb, "GET /a", $descr="with JWT")
Rel(awscf, eap, "GET /b", $descr="with JWT")

Rel(awsalb, b1, "GET /a", $descr="with JWT")
...
* https://github.com/plantuml-stdlib/C4-PlantUML?tab=readme-ov-file#container-diagram[C4-PlantUML - Container diagram]
* https://github.com/awslabs/aws-icons-for-plantuml[AWS Icons for PlantUML]
